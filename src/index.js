...
const whitelist = ['http://localhost:3000', 'http://localhost:8080', 'https://chromeswap.herokuapp.com', 'https://web-production-29fc.up.railway.app', 'https://kind-pink-gopher-coat.cyclic.app']
