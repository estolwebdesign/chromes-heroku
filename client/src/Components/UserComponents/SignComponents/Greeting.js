...
const Greeting = () => {
  return (
    <section id="wellcome" className="bg-light rounded shadow mt-3 p-3">
      <h1 className=" text-center fw-bold text-qatar">Bienvenido a ChromeSwap!!!</h1>
      <p className="text-center fw-bold">Bienvenido a ChromeSwap, el primer sitio de intercambio de figuritas del mundial Qatar 2022.</p>
      <div className="text-justify">
        <p>
          En ChromeSwap podras registrar tus figuritas, las que tienes sin repetir y las repetidas. Luego vas a poder buscar las figuritas repetidas de las personas que tienes cerca, ponerte en
      ...
      <h4 className="text-center">Muchas gracias por visitarnos!</h4>
    </section>
  );
};
