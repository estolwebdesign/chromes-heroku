exports.newContactEmail = (contact) => {
    return `<!DOCTYPE html>
    <html lang="es">
      <head>
        <meta charset="UTF-8" />
      ...
      <body class="clean-body" style="margin: 0; padding: 0; -webkit-text-size-adjust: 100%; background-color: #f8f9fa">
        ...
        <main style="display: flex" class="bg-light">
          <section class="w-500 mx-auto border p-3">
            <h2 class="center mt-0">Nueva solicitud de contacto.</h2>
            <p>Hemos recibido una nueva solicitud de contacto</p>
            <div style="display: flex">
                <p style="width: 25%"><strong>Nombre:</strong></p>
                <p style="width: 75%">${contact.name}</p>
            </div>
            <div style="display: flex">
                <p style="width: 25%"><strong>Email:</strong></p>
                <p style="width: 75%">${contact.email}</p>
            </div>
            <div style="display: flex">
                <p style="width: 25%"><strong>Mensaje:</strong></p>
                <p style="width: 75%">${contact.message}</p>
            </div>
          </section>
        </main>
